...
- 2.2 **Load filament**. Refer to [**here**](https://github.com/ZONESTAR3D/Z8P/tree/main/Z8P-MK2/2-Operation_Guide#load-filaments) to load all 4 filaments to the extruders and hotend.
...
- 2.6 **Load filaments - 4 colors**. Refer to this [:movie_camera: video tutorial]() to load 4 color filaments to the extruders and hotend.
