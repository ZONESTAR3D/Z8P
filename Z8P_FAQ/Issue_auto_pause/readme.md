...
### 1. Désactivez la fonction « Détection d'épuisement du filament » sur le MENU LCD : ***Control>>Configure>>Runout Sensor***.
...
### 1. Disattivare la funzione "Rilevamento esaurimento filamento" sul MENU LCD: ***Control>>Configure>>Runout Sensor***.
...
### 1. Отключите функцию «Обнаружение биения нити» в МЕНЮ ЖК-дисплея: ***Control>>Configure>>Runout Sensor***.
...
### 1. LCD メニューの「フィラメント振れ検出」機能をオフにします: ***Control>>Configure>>Runout Sensor***。
...
### 1. LCD 메뉴에서 "필라멘트 런아웃 감지" 기능을 끄십시오: ***Control>>Configure>>Runout Sensor***.
