...
### Step:one:: Download repetier-host software (Click [:arrow_down:here](https://www.repetier.com/download-now/) to download) and then install to your PC.    
Don't choose the "Repetier-Server" when installing the software.    
![](./repetierserver.jpg)     
