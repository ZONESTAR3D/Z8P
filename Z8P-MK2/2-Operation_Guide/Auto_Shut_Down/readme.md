...
----
## <a id="en">Auto Shut Down Feature User Guide</a>
...
----
## <a id="es">Guía del usuario de la función de apagado automático</a> [:arrow_heading_up:](#choose-language)
### Active la función de apagado automático en la pantalla LCD
...
----
## <a id="pt">Guia do usuário do recurso de desligamento automático</a> [:arrow_heading_up:](#choose-language)
### Ative o recurso de desligamento automático na tela LCD
...
----
## <a id="fr">Guide de l'utilisateur de la fonctionnalité d'arrêt automatique</a> [:arrow_heading_up:](#choose-language)
### Activez la fonction d'arrêt automatique sur l'écran LCD
...
----
## <a id="de">Benutzerhandbuch für die automatische Abschaltfunktion</a> [:arrow_heading_up:](#choose-language)
### Schalten Sie die automatische Abschaltfunktion auf dem LCD-Bildschirm ein
...
----
## <a id="it">Guida per l'utente della funzione di spegnimento automatico</a> [:arrow_heading_up:](#choose-language)
### Attiva la funzione di spegnimento automatico sullo schermo LCD
...
----
## <a id="ru">Руководство пользователя функции автоматического выключения</a> [:arrow_heading_up:](#choose-language)
### Включите функцию автоматического выключения на ЖК-экране
...
----
## <a id="jp">自動シャットダウン機能ユーザーガイド</a> [:arrow_heading_up:](#choose-language)
### LCD 画面の自動シャットダウン機能をオンにします
...
----
## <a id="kr">자동 종료 기능 사용 설명서</a>  [:arrow_heading_up:](#choose-language)
### LCD 화면의 자동 종료 기능을 켜세요.
...
----
## <a id="ar">دليل مستخدم ميزة إيقاف التشغيل التلقائي</a> [:arrow_heading_up:](#choose-language)
### تشغيل خاصية إيقاف التشغيل التلقائي على شاشة LCD
