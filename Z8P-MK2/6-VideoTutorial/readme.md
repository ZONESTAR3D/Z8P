...
----
## Content
- **[1. Installation Guide](#1️⃣-installation-guide)**
  - [Installation](#installation)    
  - [Wiring](#wiring)    
- **[2. Operation Guide](#2️⃣-operation-guide)**   
  - [Power On/OFF](#power-onoff)    
  - [Bed leveling](#bed-leveling)      
  - [Load filament](#load-filament)    
  - [Print from SD card](#print-from-sd-card)    
  - [Gradient mix color](#gradient-mix-color)   
  - [Random mix color](#random-mix-color)   
- **[3. Slicing](#3️⃣-slicing)**   
  - [Install slicer software](#install-slicer-software)    
  - [Slicing for One Color printing](#slicing-for-one-color-printing)    
  - [Slicing for Multi Color printing](#slicing-for-multi-color-printing)    
  - [Slicing for Combine Multi 3d model files](#slicing-for-combine-multi-3d-model-files)    
  - [Slicing for Painting color to 3d model](#slicing-for-painting-color-to-3d-model)    
- **[4. Advance Features](#4️⃣-advance-features-guide)**   
  - [Power auto shutdown](#power-auto-shutdown)
  - [Bed auto leveling](#bed-auto-leveling)
  - [Power loss recovery](#power-loss-recovery)
  - [Speedy printing](#speedy-printing)
- **[5. Maintenance and Repair](#5️⃣-maintenance-and-repair)**   
  - [Auto testing](#machine-electronics-parts-auto-testing)
  - [Replace a nozzle](#replace-a-nozzle)
...
- **[:book: Maunal][cleanM4V6]**
- **[:clapper: Video Tutorial - HD](https://youtu.be/L5VRyEbsJvM)** 
#### Replace inner PTFE tubes of M4V6 Hotend
- **[:book: Maunal][ReplaceM4V6InnerPTFE]**
- **[:clapper: Video Tutorial - HD](https://youtu.be/L5VRyEbsJvM)** 
